    ...
    <table width="100%" style="max-width: 600px; margin: 0 auto; background-color: #fff; border-radius: 10px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
        ...
        <tr>
            <td style="padding: 30px;">
                ...
                <p>Thank you for helping improve DHVSU's graduate tracking and academic excellence.</p>

                <p style="color: #999;">This is an automated email from DHVSU Alumni Tracer System.</p>
            </td>
        </tr>
    </table>
</body>
